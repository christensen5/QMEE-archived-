# Runs the stochastic Ricker Eqn in its recursion form, with and 
...
stochrickvect1<-function(p0=runif(1000,0.5,1.5),r=1.2,K=1,sigma=.2,numyears=100)
{
  N<-matrix(NA,numyears,length(p0))
  N[1,]<-p0
  for (counter in 2:numyears) #for each pop, loop through the years
...
print("Yet another Vectorized Stochastic Ricker takes:")
