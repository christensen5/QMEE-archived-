...
# 	Tests  whether 
#       temperature of one year is significantly correlated with the
#       next year, then compares value with null distribution.
...
progb <- txtProgressBar(min = 0, max = 10000, style = 3) # create progress bar for loop
for(i in 1:10000) {
