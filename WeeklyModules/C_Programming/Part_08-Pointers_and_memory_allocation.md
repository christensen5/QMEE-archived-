...
*(populations_ptr + 4);
```
<!-- TG: I feel it'll be clearer if you flip these two examples around (first the *(pop_ptr +4) and then the other ones). I'm afraid they'll get confused here and will block on the first code snippet. -->
...
<!-- TG: do you introduce typecasting before? I don't remember -->
...
<!-- TG: how about just ignoring it then? - Maybe just mention it verbally during the course? -->
