...
outfile_u = File("/media/alexander/DATA/Ubuntu/Miniproject/ParcelsDrake/outputs/H_3D/motility/" + folderstr + "/u.pvd")
outfile_particles = pset.ParticleFile(name="/media/alexander/DATA/Ubuntu/Miniproject/ParcelsDrake/outputs/H_3D/motility/" + folderstr + "/Gyrotaxis_test", outputdt=timedelta(seconds=dt_NS))#, type='indexed')
