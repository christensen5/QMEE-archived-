...
# vector of presents
presents_classic <- c("Partridge in a pear tree","Turtle Doves","French Hens","Calling Birds","Golden Rings","Geese A-laying","Swans A-swimming","Maids A-milking","Ladies Dancing","Lords A-leaping","Pipers Piping","Drummers Drumming","CMEE studnets")
...
twelvedays <- function(presents=presents_classic) {
    ...
    for (days in 1:num_days){
        ...
        part3 <- " day of christmas my true love sent to me"
